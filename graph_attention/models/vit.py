...
class ViT(nn.Module):
    def __init__(
        ...
        **agf_kwargs,
        ...
        self.pos_embedding = nn.Parameter(torch.randn(1, total_tokens, dim) * 0.02)
        self.pos_drop = nn.Dropout(p=0.0)

        self.backbone = Transformer(depth, dim, num_heads, attention_layer, mlp_ratio, **agf_kwargs)
